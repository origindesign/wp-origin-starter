...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<div class="wp-block-group">
		<!-- wp:post-terms {"term":"category","prefix":"<?php echo esc_html__( 'Categories: ', 'origin' )?>"} /-->
		</div>
		<!-- /wp:group -->
		</div>
		<!-- /wp:group -->
	...
	<!-- wp:query-no-results -->
	<!-- wp:paragraph -->
	<p><?php esc_html_e( 'No results', 'origin' ); ?></p>
	<!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
	<!-- wp:query-pagination {"paginationArrow":"arrow","layout":{"type":"flex","justifyContent":"space-between"}} -->
	<!-- wp:query-pagination-previous {"label":"<?php esc_html_e( 'Previous', 'origin'); ?>"} /-->
	<!-- wp:query-pagination-next {"label":"<?php esc_html_e( 'Next', 'origin'); ?>"} /-->
	<!-- /wp:query-pagination -->
</div>
<!-- /wp:query -->
